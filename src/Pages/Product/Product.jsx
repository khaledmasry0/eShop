          ...
          <Row>
            ...
            <Col xs={12} md={6} className="flex_center mt-sm-4">
              <div className="product_info flex_center flex-column gap-2">
                ...
                <p className="rating">
                  Rating <span>4.9</span> <FontAwesomeIcon icon={faStar} />
                </p>
                <div className="price">
                  <span className="currentPrice">EGP {myp.price}</span>
                  {myp.oldprice && (
                    <span className="oldprice">EGP {myp.oldprice}</span>
                  )}
                </div>
                <p className="text text-center">
                  This Product is Great to choose, You Will be A Special, And
                  You should Follow Us Because our Amazing Next Products
                </p>
                <span className="fav" ref={svgicon} onClick={handlefav}>
                  {togglefav ? (
                ...
                <div className="linkstochart d-flex gap-2">
                  <button
                    ...
                    onClick={() => dispatch(addItemtochart(myp))}
                  >
                    Add To Chart
                  </button>
