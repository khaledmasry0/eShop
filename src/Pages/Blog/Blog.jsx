                ...
                <figure>
                  ...
                  <figcaption>
                    ...
                    <p className="text">
                      ...
                      world closer together.To provide the best customer service
                      possible. Deliver WOW through service.
                    </p>
                    <div className="info">
                      <p>
                        By <span>Admin</span>
                      ...
                      <Link to="/Blog" className="continue">
            ...
            <Col xs={12} md={4} className="mt-4 mt-md-0">
              <div className="blog_features">
                ...
                <ul className="cat">
                  ...
                  <li>
                    <Link to="/Products">Street Style</Link>
                  </li>
                  <li>
                    <Link to="/Products">Life Style</Link>
                  </li>
                  <li>
                    <Link to="/Products">DIY & Crafts</Link>
                  </li>
                </ul>
                ...
                <ul className="tags">
                  ...
                  <li>
                    <Link to="/Products">Streetstyle</Link>
                  </li>
                  <li>
