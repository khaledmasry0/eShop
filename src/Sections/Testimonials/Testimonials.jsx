      ...
      >
        <SwiperSlide className="test text-center flex_center flex-column">
          <p className="test_text">
            People are easily swayed by others, especially when shopping online.
            This is why independent review sites like Elmasry-eShop, GoodReads,
            and many others are so popular.
          </p>
        ...
        <SwiperSlide className="test text-center flex_center flex-column">
          <p className="test_text">
            These review sites are fantastic because no one forces your
            customers to share a review or post, so they are perceived as truly
